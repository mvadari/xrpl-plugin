...
// Also try this
#[no_mangle]
pub fn preflight(ctx: &rippled::PreflightContext) -> i32 {
    pre_flight(ctx)
}

#[no_mangle]
pub fn preclaim(ctx: &rippled::PreclaimContext) -> i32 {
    pre_claim(ctx)
}

#[no_mangle]
pub fn calculateBaseFee(view: &rippled::ReadView, tx: &rippled::STTx) -> i64 {
    1
}


#[no_mangle]
pub fn doApply(ctx: &rippled::ApplyContext, mPriorBalance: rippled::XRPAmount, mSourceBalance: rippled::XRPAmount) -> i32 {
    println!("calling RUST doApply");
...
pub mod rippled {
    ...
    extern "Rust" {
        ...
        // compatible.
        pub fn preflight(ctx: &PreflightContext) -> i32;
        pub fn preclaim(ctx: &PreclaimContext) -> i32;
    }
    ...
    unsafe extern "C++" {
        ...
        // pub fn calculateBaseFee(self: &Transactor, view: &ReadView, tx: &STTx) -> XRPAmount;
    }
}