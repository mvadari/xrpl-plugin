...
{
    py::module_::import("sys").attr("path").attr("append")("/Users/javiromero/Documents/dev/xrpl-plugins/xrpl-plugin/examples/token_swap");
    py::module module = py::module_::import("");
...
getTransactors()
{
    static std::vector<TransactorExportInternal> const transactors = []{
        ...
        CustomScopedInterpreter guard{}; // start the interpreter and keep it alive
        py::module_::import("sys").attr("path").attr("append")("/Users/javiromero/Documents/dev/xrpl-plugins/xrpl-plugin/examples/token_swap");
        py::module pluginImport = py::module_::import("");
...
getLedgerObjects()
{
    static std::vector<LedgerObjectExportInternal> const objects = []{
        CustomScopedInterpreter guard{}; // start the interpreter and keep it alive
        py::module_::import("sys").attr("path").attr("append")("/Users/javiromero/Documents/dev/xrpl-plugins/xrpl-plugin/examples/token_swap");
        py::module_ module = py::module_::import("");
