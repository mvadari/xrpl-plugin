#[===================================================================[
   plugin transactor compile options/settings via an interface library
#]===================================================================]

add_library (plugin INTERFACE)
add_library (Plugin::opts ALIAS plugin)
...
if (jemalloc)
  ...
  target_compile_definitions (plugin INTERFACE PROFILE_JEMALLOC)
  target_include_directories (plugin SYSTEM INTERFACE ${JEMALLOC_INCLUDE_DIRS})
  target_link_libraries (plugin INTERFACE ${JEMALLOC_LIBRARIES})
...
if (san)
  ...
  target_link_libraries (plugin INTERFACE ${SAN_FLAG} ${SAN_LIB})
endif ()
